...
---
# Introduction:
> Write a short introduction that touches on each point in the article:  
...
> Good spot for a chat gpt created image (possibly use the dragon slayer analogy as a "thing" in the article)
...
> Another spot for a chatgpt image
...
## Conclusion
> Sign off with a nice conclusion paragraph. If you have any ideas for future articles here is a good place to hint at them.
